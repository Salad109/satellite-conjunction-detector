...
# Plot 1 - Total time (individual iterations + mean)
...
# Plot 2 - Stacked bar (mean timings)
fig, ax = plt.subplots(figsize=(10, 6))
x = range(len(avg))
bottom = [0] * len(avg)
...
ax.set_title('Mean Time Breakdown by Interpolation Stride', fontsize=14, fontweight='bold')
